...
kbdcfg = deficient.keyboard_layout_indicator({
    layouts = {
	    ...
	    {name="de", layout="de", variant="nodeadkeys"}
    }
})
...
beautiful.init("/home/luki/.config/awesome/theme.lua")
...
widget_separator = wibox.widget.textbox(" | ")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local layouts = { l.tile.left, l.max, l.tile.left, l.tile.left } -- , l.tile.left,
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
			...
			cpuinfo.widget,
			widget_separator,
			awful.widget.watch('/home/luki/bin/ram_usage.sh', 10),
			widget_separator,
			battery_widget,
			widget_separator,
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey, "Control" }, "j",
		function () awful.client.incwfact(-0.02) end
	),
    ...
    awful.key({ modkey, "Shift" }, "r", function() kbdcfg:next() end ),
    -- Volume control
